...
const h = (t) => /* @__PURE__ */ (0,jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "1rem", height: "1rem", fill: "none", viewBox: "0 0 24 24", ...t, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
  "path",
  {
    fill: "#212134",
...
const getIcon = (listDeployAvailability) => {
  switch (listDeployAvailability) {
    case "MISSING_CONFIG_OBJECT":
      return wrapIcon(/* @__PURE__ */ react.createElement(ExclamationMarkCircle/* default */.Z, null));
    case "MISSING_CONFIG_VARIABLE":
      return wrapIcon(/* @__PURE__ */ react.createElement(EmptyPermissions/* default */.Z, null));
    case "MISSING_DEPLOYMENTS":
      return wrapIcon(/* @__PURE__ */ react.createElement(EmptyDocuments/* default */.Z, null));
    case "ERROR_DEPLOYMENTS":
    case "ERROR_AVAILABILITY_GENERIC":
    case "ERROR_AVAILABILITY_FORBIDDEN":
    case "ERROR_CONFIG":
    default:
      return wrapIcon(/* @__PURE__ */ react.createElement(n, null));
  }
};
...
const DeployButton = ({
  ...
  return /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "center" } }, isLoading && /* @__PURE__ */ react.createElement(components_SymmetricBox, { paddingHorizontal: 4 }, /* @__PURE__ */ react.createElement(Loader/* Loader */.a, { small: true }, labelLoader)), /* @__PURE__ */ react.createElement(components_SymmetricBox, { paddingHorizontal: 4 }, /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: runDeployHandler, disabled: !canDeploy || isLoading }, /* @__PURE__ */ react.createElement("div", { style: { display: "flex", alignItems: "center" } }, /* @__PURE__ */ react.createElement(Plus/* default */.Z, null), /* @__PURE__ */ react.createElement("span", { style: { width: "8px" } }), /* @__PURE__ */ react.createElement(FormattedMessage/* default */.Z, { labelId: "deploy-button.label" })))));
};
...
const SettingsApp = () => {
  return /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `/settings/${(pluginId_default())}`, component: pages_SettingsPage, exact: true }), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { component: helper_plugin_esm.NotFound })));
};
...
axios.isCancel = __webpack_require__(59642);
...
var isCancel = __webpack_require__(59642);
var defaults = __webpack_require__(62087);
var Cancel = __webpack_require__(7336);
...
const R = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .ZP)(_BaseButton_BaseButton_js__WEBPACK_IMPORTED_MODULE_3__/* .BaseButtonWrapper */ .G)`
  &[aria-disabled='true'] {
